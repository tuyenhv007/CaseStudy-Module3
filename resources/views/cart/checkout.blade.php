                ...
                <div class="order-summary">
                    ...
                    <div class="order-products">
                        ...
                        <div class="order-col">
                            ...
                            <div><img style="width: 50px"  src={{asset("storage/".$item['item']->image)}} /> </div>
                            <div>{{ $item['totalQty'] }}x {{ $item['item']->name }}</div>
                            <div>{{number_format($item['totalPrice'])}} VNĐ</div>
                    ...
                    <div class="order-col">
                        <div><strong>TOTAL</strong></div>
                        <div><strong class="order-total">{{number_format($cart->totalPrice)}} VNĐ</strong></div>
                    </div>
                </div>
