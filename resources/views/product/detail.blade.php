    ...
    <div id="top-header">
        <div class="container">
            <ul class="header-links pull-left">
                <li><a href="#"><i class="fa fa-phone"></i> 0965279961</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div>
                        <h3 class="product-price">{{number_format($product->price)}} VNĐ <del class="product-old-price"></del></h3>
                    ...
                    <div class="add-to-cart">
                        ...
                        <a href="{{route('add-to-cart',$product->id)}}" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</a>
                    </div>
                                        ...
                                        <ul class="reviews">
                                            <li>
                                                <div class="review-heading">
                                                    <h5 class="name">Thắng Bùi</h5>
                                                    <p class="date">8 July 2020, 8:00 PM</p>
                                                ...
                                                <div class="review-body">
                                                    <p>Shop uy tín , sản phẩm chất lượng</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="review-heading">
                                                    <h5 class="name">Chiến Mạnh</h5>
                                                    <p class="date">7 July 2020, 10:20 AM</p>
                                                    <div class="review-rating">
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                ...
                                                <div class="review-body">
                                                    <p>Mình vừa mới mua , rất là ưng luôn ^^</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="review-heading">
                                                    <h5 class="name">Quân xúc tu</h5>
                                                    <p class="date">1 July 2020, 5:36 PM</p>
                                                    <div class="review-rating">
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star-o empty"></i>
                                                        <i class="fa fa-star-o empty"></i>
