...
";
        ...
        $product->decs = "Apple Macbook Pro Touch Bar 2019 MV962 - 13 Inchs (i5/ 8GB/ 256GB) - Hàng Chính Hãng
";
        $product->qty = 26;
...
";
        ...
        $product = new \App\Product();
        $product->name = "Apple Macbook Pro Touch Bar 2019 - 13 inchs

";
        $product->price = 41999000;
        $product->decs = "Apple Macbook Pro Touch Bar 2019 - 13 inchs (i5/ 8GB/ 256GB) - Hàng Nhập Khẩu Chính Hãng
        $product->qty = 56;
";
